<template>
    <section class="section content">
        ...
        <lightbox :images="gal13"></lightbox>
                ...
                <article>
            <h3>
                Помещения для чтения книг
            </h3>
            <p>
                Для посетителей АНО «ЦСП «Шатлык» «Радость» в здании учреждения размещены стенды и уголки, на которых представлена информация о новшествах законодательства в сфере социального обслуживания граждан, порядок и условия предоставления социальных услуг, тарифы на социальные услуги и др. Для посетителей имеются столики с газетами, буклетами о деятельности и  новинках законодательства, а так же  периодическими изданиями и журналами.
В холле центра стоят стенды с информационными буклетами и памятками.
            </p>
            <p>
            Кабинет оснащен современной мебелью, книжными шкафами для хранения методической литературы, информационно-методических и справочных изданий, буклетов, листовок, стендом для размещения актуальной информации.
            </p>
        </article>
        <article>
            ...
            <h5>Кабинеты физиотерапии оснащены:</h5>
            <ul>
                ...
                <li>сухой углекислой ванной «Реабокс»</li>
            </ul>
        ...
        <article>
            ...
            <p>
                В перечень гарантированных социально-бытовых услуг в том числе входит обеспечение питанием (на 2021 г.):
                <table>
                    <tbody>
                        <tr>
                            <td>
        ...
        <article>
            ...
            <p>
                Для быстрой и корректной работы учреждение оснащено различными программными продуктами, способствующими более эффективной работы персонала учреждения. Имеется доступ к информационным системам в сфере социального обслуживания и сети "Интернет". 
            </p>
            <p>
Специалисты АНО «ЦСП «Шатлык» («Радость») проводят работу в Информационных системах ГИС "Социальный регистр населения РТ". Данный вид деятельности позволяет проводить мониторинг социального обслуживания учреждений РТ и осуществлять государственный контроль и надзор в сфере социального обслуживания.
            </p>
            <p>
В центре имеется Wi-Fi.
            </p>
        </article>
        <article>
            <h3>
...
import gal6img13 from "../../../assets/кабинет физиотерапии/DSC_8593.JPG";
...
import gal6img13thumb from "../../../assets/кабинет физиотерапии/DSC_8593.JPG";
...
import gal9img1 from "../../../assets/кабинет гирудотерапии/IMG_0301-min.jpg";
...
import gal9img1thumb from "../../../assets/кабинет гирудотерапии/IMG_0301-min.resized.jpg";
  ...
  data() {
    return {
      ...
      gal6: [
        ...
        { src: gal6img13, thumb: gal6img13thumb },
      ],
      gal7: [
